...
/**
 * EducationObservationResource — Una entrada de la bitácora de observaciones.
 *
 ...
 * educativo antes de entregar el archivo.
 */
class EducationObservationResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'attachment_url'   => $this->attachment_path
                ? route('education-observations.attachment', $this->id)
                : null,
